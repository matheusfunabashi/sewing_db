...
export default function CustomerFormScreen({ navigation }: any) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 16 }}>
      <Text style={styles.title}>Workflow 1 - Register customer</Text>
      <Text style={styles.subtitle}>
        Fill in the details. Once saved you can create an order for this customer.
      </Text>

      <View style={{ height: 16 }} />

      <Field label="Full name *"  value={full_name} onChangeText={setName}    placeholder="Maria Silva" />
      <Field label="Phone"        value={phone}     onChangeText={setPhone}   placeholder="+351 ..."          keyboardType="phone-pad" />
      ...
      <Field label="Preferences"  value={preferences} onChangeText={setPref}  placeholder="Slim fit, dark colors" multiline />
